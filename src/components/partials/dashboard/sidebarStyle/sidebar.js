               ...
               <div id="sidebar-scrollbar">
                  <nav className="iq-sidebar-menu">
                     <Accordion as="ul" id="iq-sidebar-toggle" className="iq-menu">
                        ...
                        <li className={`${location.pathname === '/dashboards/app/live-stream' ? 'active' : '' }` }>
                           <Link to="/dashboards/app/live-stream" ><i className="las la-user"></i><span>Live-Streaming</span></Link>
                        </li>
                        ...
                        <li className={`${location.pathname === '/dashboards/app/calendar' ? 'active' : ''}`}>
                           <Link to="/dashboards/app/calendar" ><i className="las la-calendar"></i><span>Calendar</span></Link>
                        </li>
                        <li className={`${location.pathname === '/dashboards/app/birthday' ? 'active' : ''}`}>
                           <Link to="/dashboards/app/birthday" ><i className="las la-birthday-cake"></i><span>Birthday</span></Link>
                        </li>
                        ...
                        {/* <Accordion.Item as="li" className={`${location.pathname === '/dashboard/Email/email' || location.pathname === '/dashboard/Email/email-compose'?  'active' : ''}`}  eventKey="sidebar-email"  >
                           ...
                           <Accordion.Collapse eventKey="sidebar-email">
                              <ul id="mailbox" className="iq-submenu ">
                                 <li className={`${location.pathname === '/dashboard/Email/email' ? 'active' : ''}`}>
                                    <Link to="/dashboard/Email/email">
                                       <i className="ri-inbox-line"></i>Inbox
                                    </Link>
                                 </li>
                                 <li className={`${location.pathname === '/dashboard/Email/email-compose' ? 'active' : ''}`}>
                        ...
                        {/* <Accordion.Item as="li" className={`${location.pathname === '/dashboard/ui-kit/ui-color' || location.pathname === '/dashboard/ui-kit/ui-typography' || location.pathname === '/dashboard/ui-kit/ui-alerts' || location.pathname === '/dashboard/ui-kit/ui-badges'|| location.pathname === '/dashboard/ui-kit/ui-breadcrumb'||  location.pathname === '/dashboard/ui-kit/ui-buttons' ||location.pathname === '/dashboard/ui-kit/ui-cards' || location.pathname === '/dashboard/ui-kit/ui-carousel' || location.pathname === '/dashboard/ui-kit/ui-embed-video' || location.pathname === '/dashboard/ui-kit/ui-grid'|| location.pathname === '/dashboard/ui-kit/ui-images'|| location.pathname === '/dashboard/ui-kit/ui-list-groups' || location.pathname === '/dashboard/ui-kit/ui-notifications'|| location.pathname === '/dashboard/ui-kit/ui-modal' || location.pathname === '/dashboard/ui-kit/ui-pagination' ||  location.pathname === '/dashboard/ui-kit/ui-popovers' || location.pathname === '/dashboard/ui-kit/ui-progressbars'|| location.pathname === '/dashboard/ui-kit/ui-tabs'|| location.pathname === '/dashboard/ui-kit/ui-tooltips'|| location.pathname === '/dashboard/form/form-element'||  location.pathname === '/dashboard/form/form-validation'|| location.pathname === '/dashboard/form/form-switch'  || location.pathname === '/dashboard/form/form-checkbox' || location.pathname === '/dashboard/form/form-radio'||  location.pathname === '/dashboard/form/form-wizard'|| location.pathname === '/dashboard/form/form-wizard-validate'|| location.pathname === '/dashboard/form/form-wizard-vertical' || location.pathname === '/dashboard/table/tables-basic' || location.pathname === '/dashboard/table/data-table' || location.pathname === '/dashboard/table/table-editable'|| location.pathname === '/dashboard/icon/fontawesome-5' || location.pathname === '/dashboard/icon/lineawesome'|| location.pathname === '/dashboard/icon/remixicon'?   'active' : ''}`}  eventKey="sidebar-ui"  >
                           ...
                           <Accordion.Collapse eventKey="sidebar-ui">
                              <Accordion as="ul" id="ui-elements" className="iq-submenu ">
                                 <Accordion.Item as="li" className={`${location.pathname === '/dashboard/ui-kit/ui-color' || location.pathname === '/dashboard/ui-kit/ui-typography' || location.pathname === '/dashboard/ui-kit/ui-alerts' || location.pathname === '/dashboard/ui-kit/ui-badges'|| location.pathname === '/dashboard/ui-kit/ui-breadcrumb'||  location.pathname === '/dashboard/ui-kit/ui-buttons' ||location.pathname === '/dashboard/ui-kit/ui-cards' || location.pathname === '/dashboard/ui-kit/ui-carousel' || location.pathname === '/dashboard/ui-kit/ui-embed-video' || location.pathname === '/dashboard/ui-kit/ui-grid'|| location.pathname === '/dashboard/ui-kit/ui-images'|| location.pathname === '/dashboard/ui-kit/ui-list-groups' || location.pathname === '/dashboard/ui-kit/ui-notifications'|| location.pathname === '/dashboard/ui-kit/ui-modal' || location.pathname === '/dashboard/ui-kit/ui-pagination' ||  location.pathname === '/dashboard/ui-kit/ui-popovers' || location.pathname === '/dashboard/ui-kit/ui-progressbars'|| location.pathname === '/dashboard/ui-kit/ui-tabs'|| location.pathname === '/dashboard/ui-kit/ui-tooltips'|| location.pathname === '/dashboard/form/form-element'||  location.pathname === '/dashboard/form/form-validation'|| location.pathname === '/dashboard/form/form-switch'  || location.pathname === '/dashboard/form/form-checkbox' || location.pathname === '/dashboard/form/form-radio'||  location.pathname === '/dashboard/form/form-wizard'|| location.pathname === '/dashboard/form/form-wizard-validate'|| location.pathname === '/dashboard/form/form-wizard-vertical' || location.pathname === '/dashboard/table/tables-basic' || location.pathname === '/dashboard/table/data-table' || location.pathname === '/dashboard/table/table-editable'|| location.pathname === '/dashboard/icon/fontawesome-5' || location.pathname === '/dashboard/icon/lineawesome'|| location.pathname === '/dashboard/icon/remixicon'?   'active' : ''}`}   eventKey="sidebar-uikit"  >
                                    <CustomToggle eventKey="sidebar-uikit" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                 ...
                                 <Accordion.Item as="li" className={`${location.pathname === '/dashboard/ui-kit/ui-color' || location.pathname === '/dashboard/ui-kit/ui-typography' || location.pathname === '/dashboard/ui-kit/ui-alerts' || location.pathname === '/dashboard/ui-kit/ui-badges'|| location.pathname === '/dashboard/ui-kit/ui-breadcrumb'||  location.pathname === '/dashboard/ui-kit/ui-buttons' ||location.pathname === '/dashboard/ui-kit/ui-cards' || location.pathname === '/dashboard/ui-kit/ui-carousel' || location.pathname === '/dashboard/ui-kit/ui-embed-video' || location.pathname === '/dashboard/ui-kit/ui-grid'|| location.pathname === '/dashboard/ui-kit/ui-images'|| location.pathname === '/dashboard/ui-kit/ui-list-groups' || location.pathname === '/dashboard/ui-kit/ui-notifications'|| location.pathname === '/dashboard/ui-kit/ui-modal' || location.pathname === '/dashboard/ui-kit/ui-pagination' ||  location.pathname === '/dashboard/ui-kit/ui-popovers' || location.pathname === '/dashboard/ui-kit/ui-progressbars'|| location.pathname === '/dashboard/ui-kit/ui-tabs'|| location.pathname === '/dashboard/ui-kit/ui-tooltips'|| location.pathname === '/dashboard/form/form-element'||  location.pathname === '/dashboard/form/form-validation'|| location.pathname === '/dashboard/form/form-switch'  || location.pathname === '/dashboard/form/form-checkbox' || location.pathname === '/dashboard/form/form-radio'||  location.pathname === '/dashboard/form/form-wizard'|| location.pathname === '/dashboard/form/form-wizard-validate'|| location.pathname === '/dashboard/form/form-wizard-vertical' || location.pathname === '/dashboard/table/tables-basic' || location.pathname === '/dashboard/table/data-table' || location.pathname === '/dashboard/table/table-editable'|| location.pathname === '/dashboard/icon/fontawesome-5' || location.pathname === '/dashboard/icon/lineawesome'|| location.pathname === '/dashboard/icon/remixicon'?   'active' : ''}`}   eventKey="sidebar-form"  >
                                    <CustomToggle eventKey="sidebar-uiform" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                    ...
                                    <Accordion.Collapse eventKey="sidebar-uiform">
                                       <ul id="forms" className="iq-submenu ">
                                          <li className={`${location.pathname === '/dashboard/form/form-element' ? 'active' : ''}`}>
                                             <Link to="/dashboard/form/form-element">
                                                <i className="ri-tablet-line"></i>Form Elements
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/form/form-validation' ? 'active' : ''}`}>
                                             <Link to="/dashboard/form/form-validation">
                                                <i className="ri-device-line"></i>Form Validation
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/form/form-switch' ? 'active' : ''}`}>
                                             <Link to="/dashboard/form/form-switch">
                                                <i className="ri-toggle-line"></i>Form Switch
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/form/form-checkbox' ? 'active' : ''}`}>
                                             <Link to="/dashboard/form/form-checkbox">
                                                <i className="ri-checkbox-line"></i>Form Checkbox
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/form/form-radio' ? 'active' : ''}`}>
                                 ...
                                 <Accordion.Item as="li" className={`${location.pathname === '/dashboard/ui-kit/ui-color' || location.pathname === '/dashboard/ui-kit/ui-typography' || location.pathname === '/dashboard/ui-kit/ui-alerts' || location.pathname === '/dashboard/ui-kit/ui-badges'|| location.pathname === '/dashboard/ui-kit/ui-breadcrumb'||  location.pathname === '/dashboard/ui-kit/ui-buttons' ||location.pathname === '/dashboard/ui-kit/ui-cards' || location.pathname === '/dashboard/ui-kit/ui-carousel' || location.pathname === '/dashboard/ui-kit/ui-embed-video' || location.pathname === '/dashboard/ui-kit/ui-grid'|| location.pathname === '/dashboard/ui-kit/ui-images'|| location.pathname === '/dashboard/ui-kit/ui-list-groups' || location.pathname === '/dashboard/ui-kit/ui-notifications'|| location.pathname === '/dashboard/ui-kit/ui-modal' || location.pathname === '/dashboard/ui-kit/ui-pagination' ||  location.pathname === '/dashboard/ui-kit/ui-popovers' || location.pathname === '/dashboard/ui-kit/ui-progressbars'|| location.pathname === '/dashboard/ui-kit/ui-tabs'|| location.pathname === '/dashboard/ui-kit/ui-tooltips'|| location.pathname === '/dashboard/form/form-element'||  location.pathname === '/dashboard/form/form-validation'|| location.pathname === '/dashboard/form/form-switch'  || location.pathname === '/dashboard/form/form-checkbox' || location.pathname === '/dashboard/form/form-radio'||  location.pathname === '/dashboard/form/form-wizard'|| location.pathname === '/dashboard/form/form-wizard-validate'|| location.pathname === '/dashboard/form/form-wizard-vertical' || location.pathname === '/dashboard/table/tables-basic' || location.pathname === '/dashboard/table/data-table' || location.pathname === '/dashboard/table/table-editable'|| location.pathname === '/dashboard/icon/fontawesome-5' || location.pathname === '/dashboard/icon/lineawesome'|| location.pathname === '/dashboard/icon/remixicon'?   'active' : ''}`}   eventKey="sidebar-formw"  >
                                    <CustomToggle eventKey="sidebar-uiformw" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                    ...
                                    <Accordion.Collapse eventKey="sidebar-uiformw">
                                       <ul id="wizard-form" className="iq-submenu ">
                                          <li className={`${location.pathname === '/dashboard/form/form-wizard' ? 'active' : ''}`}>
                                             <Link to="/dashboard/form/form-wizard">
                                                <i className="ri-clockwise-line"></i>Simple Wizard
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/form/form-wizard-validate' ? 'active' : ''}`}>
                                             <Link to="/dashboard/form/form-wizard-validate">
                                                <i className="ri-clockwise-2-line"></i>Validate Wizard
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/form/form-wizard-vertical' ? 'active' : ''}`}>
                                 ...
                                 <Accordion.Item as="li" className={`${location.pathname === '/dashboard/ui-kit/ui-color' || location.pathname === '/dashboard/ui-kit/ui-typography' || location.pathname === '/dashboard/ui-kit/ui-alerts' || location.pathname === '/dashboard/ui-kit/ui-badges'|| location.pathname === '/dashboard/ui-kit/ui-breadcrumb'||  location.pathname === '/dashboard/ui-kit/ui-buttons' ||location.pathname === '/dashboard/ui-kit/ui-cards' || location.pathname === '/dashboard/ui-kit/ui-carousel' || location.pathname === '/dashboard/ui-kit/ui-embed-video' || location.pathname === '/dashboard/ui-kit/ui-grid'|| location.pathname === '/dashboard/ui-kit/ui-images'|| location.pathname === '/dashboard/ui-kit/ui-list-groups' || location.pathname === '/dashboard/ui-kit/ui-notifications'|| location.pathname === '/dashboard/ui-kit/ui-modal' || location.pathname === '/dashboard/ui-kit/ui-pagination' ||  location.pathname === '/dashboard/ui-kit/ui-popovers' || location.pathname === '/dashboard/ui-kit/ui-progressbars'|| location.pathname === '/dashboard/ui-kit/ui-tabs'|| location.pathname === '/dashboard/ui-kit/ui-tooltips'|| location.pathname === '/dashboard/form/form-element'||  location.pathname === '/dashboard/form/form-validation'|| location.pathname === '/dashboard/form/form-switch'  || location.pathname === '/dashboard/form/form-checkbox' || location.pathname === '/dashboard/form/form-radio'||  location.pathname === '/dashboard/form/form-wizard'|| location.pathname === '/dashboard/form/form-wizard-validate'|| location.pathname === '/dashboard/form/form-wizard-vertical' || location.pathname === '/dashboard/table/tables-basic' || location.pathname === '/dashboard/table/data-table' || location.pathname === '/dashboard/table/table-editable'|| location.pathname === '/dashboard/icon/fontawesome-5' || location.pathname === '/dashboard/icon/lineawesome'|| location.pathname === '/dashboard/icon/remixicon'?   'active' : ''}`}  eventKey="sidebar-table"  >
                                    ...
                                    <Accordion.Collapse eventKey="sidebar-table">
                                       <ul id="tables" className="iq-submenu">
                                          <li className={`${location.pathname === '/dashboard/table/tables-basic' ? 'active' : ''}`}>
                                             <Link to="/dashboard/table/tables-basic">
                                                <i className="ri-table-line"></i>Basic Tables
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/table/data-table' ? 'active' : ''}`}>
                                             <Link to="/dashboard/table/data-table">
                                                <i className="ri-database-line"></i>Data Table
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/table/table-editable' ? 'active' : ''}`}>
                                 ...
                                 <Accordion.Item as="li" className={`${location.pathname === '/dashboard/ui-kit/ui-color' || location.pathname === '/dashboard/ui-kit/ui-typography' || location.pathname === '/dashboard/ui-kit/ui-alerts' || location.pathname === '/dashboard/ui-kit/ui-badges'|| location.pathname === '/dashboard/ui-kit/ui-breadcrumb'||  location.pathname === '/dashboard/ui-kit/ui-buttons' ||location.pathname === '/dashboard/ui-kit/ui-cards' || location.pathname === '/dashboard/ui-kit/ui-carousel' || location.pathname === '/dashboard/ui-kit/ui-embed-video' || location.pathname === '/dashboard/ui-kit/ui-grid'|| location.pathname === '/dashboard/ui-kit/ui-images'|| location.pathname === '/dashboard/ui-kit/ui-list-groups' || location.pathname === '/dashboard/ui-kit/ui-notifications'|| location.pathname === '/dashboard/ui-kit/ui-modal' || location.pathname === '/dashboard/ui-kit/ui-pagination' ||  location.pathname === '/dashboard/ui-kit/ui-popovers' || location.pathname === '/dashboard/ui-kit/ui-progressbars'|| location.pathname === '/dashboard/ui-kit/ui-tabs'|| location.pathname === '/dashboard/ui-kit/ui-tooltips'|| location.pathname === '/dashboard/form/form-element'||  location.pathname === '/dashboard/form/form-validation'|| location.pathname === '/dashboard/form/form-switch'  || location.pathname === '/dashboard/form/form-checkbox' || location.pathname === '/dashboard/form/form-radio'||  location.pathname === '/dashboard/form/form-wizard'|| location.pathname === '/dashboard/form/form-wizard-validate'|| location.pathname === '/dashboard/form/form-wizard-vertical' || location.pathname === '/dashboard/table/tables-basic' || location.pathname === '/dashboard/table/data-table' || location.pathname === '/dashboard/table/table-editable'|| location.pathname === '/dashboard/icon/fontawesome-5' || location.pathname === '/dashboard/icon/lineawesome'|| location.pathname === '/dashboard/icon/remixicon'?   'active' : ''}`}   eventKey="sidebar-icon"  >
                                    <CustomToggle eventKey="sidebar-icon" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                    ...
                                    <Accordion.Collapse eventKey="sidebar-icon">
                                       <ul id="icons" className="iq-submenu" >
                                          <li className={`${location.pathname === '/dashboard/icon/fontawesome-5' ? 'active' : ''}`}>
                                             <Link to="/dashboard/icon/fontawesome-5">
                                                <i className="ri-facebook-fill"></i>Font Awesome 5
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/icon/lineawesome' ? 'active' : ''}`}>
                                             <Link to="/dashboard/icon/lineawesome">
                                                <i className="ri-keynote-line"></i>line Awesome
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/icon/remixicon' ? 'active' : ''}`}>
                           ...
                           <Accordion.Collapse eventKey="sidebar-pages">
                              <Accordion as="ul" id="pages" className="iq-submenu">
                                 <Accordion.Item as="li" className={`${location.pathname === '/auth/sign-in' || location.pathname === '/auth/sign-up' || location.pathname === '/auth/recoverpw' || location.pathname === '/auth/confirm-mail'|| location.pathname === '/auth/lock-screen'||  location.pathname === '/dashboard/extrapages/pages-timeline' ||location.pathname === '/dashboard/extrapages/pages-invoice' || location.pathname === '/dashboard/extrapages/blankpage' || location.pathname === '/errors/error404' || location.pathname === '/errors/error500'|| location.pathname === '/dashboard/extrapages/pages-pricing'|| location.pathname === '/dashboard/extrapages/pages-pricing-one' || location.pathname === '/extra-pages/pages-maintenance'|| location.pathname === '/extra-pages/pages-comingsoon' || location.pathname === '/dashboard/extrapages/pages-faq' ?   'active' : ''}`}   eventKey="sidebar-auth"  >
                                    ...
                                    <i className="ri-pages-line"></i><span>Authentication</span><i className="ri-arrow-right-s-line iq-arrow-right"></i>
                                    </CustomToggle>
                                    <Accordion.Collapse eventKey="sidebar-auth">
                                       <ul id="authentication" className="iq-submenu ">
                                          <li className={`${location.pathname === '/auth/sign-in' ? 'active' : ''}`}><Link to="/auth/sign-in"><i className="ri-login-box-line"></i>Login</Link></li>
                                          ...
                                          <li className={`${location.pathname === '/auth/recoverpw' ? 'active' : ''}`}><Link to="/auth/recoverpw"><i className="ri-record-mail-line"></i>Recover Password</Link></li>
                                          <li className={`${location.pathname === '/auth/confirm-mail' ? 'active' : ''}`}><Link to="/auth/confirm-mail"><i className="ri-file-code-line"></i>Confirm Mail</Link></li>
                                          <li className={`${location.pathname === '/auth/lock-screen' ? 'active' : ''}`}><Link to="/auth/lock-screen"><i className="ri-lock-line"></i>Lock Screen</Link></li>
                                       </ul>
                                       </Accordion.Collapse>
                                    </Accordion.Item>
                                 <Accordion.Item as="li" className={`${location.pathname === '/auth/sign-in' || location.pathname === '/auth/sign-up' || location.pathname === '/auth/recoverpw' || location.pathname === '/auth/confirm-mail'|| location.pathname === '/auth/lock-screen'||  location.pathname === '/dashboard/extrapages/pages-timeline' ||location.pathname === '/dashboard/extrapages/pages-invoice' || location.pathname === '/dashboard/extrapages/blankpage' || location.pathname === '/errors/error404' || location.pathname === '/errors/error500'|| location.pathname === '/dashboard/extrapages/pages-pricing'|| location.pathname === '/dashboard/extrapages/pages-pricing-one' || location.pathname === '/extra-pages/pages-maintenance'|| location.pathname === '/extra-pages/pages-comingsoon' || location.pathname === '/dashboard/extrapages/pages-faq'|| activeMenu === '0' ?   'active' : ''}`}  eventKey="sidebar-extra">
                                    <CustomToggle eventKey="sidebar-extra" onClick={(activeKey) => setActiveMenu(activeKey)}>
                                    <i className="ri-pantone-line"></i><span>Extra Pages</span><i className="ri-arrow-right-s-line iq-arrow-right"></i>
                                    </CustomToggle>
                                    <Accordion.Collapse eventKey="sidebar-extra">
                                       <ul id="extra-pages" className="iq-submenu " >
                                          <li className={`${location.pathname === '/dashboard/extrapages/pages-timeline' ? 'active' : ''}`}>
                                             <Link to="/dashboard/extrapages/pages-timeline">
                                                <i className="ri-map-pin-time-line"></i>Timeline
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/extrapages/pages-invoice' ? 'active' : ''}`}>
                                             <Link to="/dashboard/extrapages/pages-invoice">
                                                <i className="ri-question-answer-line"></i>Invoice
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/extrapages/blankpage' ? 'active' : ''}`}>
                                             <Link to="/dashboard/extrapages/blankpage">
                                                <i className="ri-invision-line"></i>Blank Page
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/errors/error404' ? 'active' : ''}`}>
                                             <Link to="/errors/error404">
                                                <i className="ri-error-warning-line"></i>Error 404
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/errors/error500' ? 'active' : ''}`}>
                                             <Link to="/errors/error500">
                                                <i className="ri-error-warning-line"></i>Error 500
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/extrapages/pages-pricing' ? 'active' : ''}`}>
                                             <Link to="/dashboard/extrapages/pages-pricing">
                                                <i className="ri-price-tag-line"></i>Pricing
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/dashboard/extrapages/pages-pricing-one' ? 'active' : ''}`}>
                                             <Link to="/dashboard/extrapages/pages-pricing-one">
                                                <i className="ri-price-tag-2-line"></i>Pricing 1
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/extra-pages/pages-maintenance' ? 'active' : ''}`}>
                                             <Link to="/extra-pages/pages-maintenance">
                                                <i className="ri-archive-line"></i>Maintenance
                                             </Link>
                                          </li>
                                          <li className={`${location.pathname === '/extra-pages/pages-comingsoon' ? 'active' : ''}`}>
